...
def Page1():
    ...
    canvas.create_rectangle(50, 140, 850, 600, fill="white")
    ...
    global button
    button = Button(
        canvas, text='>', height=1, width=1, bg="grey", fg="white", font=("Arial", 50), borderwidth=0, command=NEXT
    )
...
def options(question):
    option_1 = Button(
        canvas, text=dic["choices"][question - 1][0], height=1, width=18, bg="white", fg="black",
        font=("Arial", 20), borderwidth=8, highlightbackground="grey",
        command=lambda: Update_score(question - 1, 1)
    )
    option_1.place(x=100, y=300)
    option_2 = Button(
        canvas, text=dic["choices"][question - 1][1], height=1, width=18, bg="white", fg="black",
        font=("Arial", 20), borderwidth=8, highlightbackground="grey",
        command=lambda: Update_score(question - 1, 2)
    )
    option_2.place(x=100, y=400)
    option_3 = Button(
        canvas, text=dic["choices"][question- 1][2], height=1, width=18, bg="white", fg="black",
        font=("Arial", 20), borderwidth=8, highlightbackground="grey",
